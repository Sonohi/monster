...
%   CwdMatrixInfo	    	->  tb info storing structure
	...
	cwdMatrix(1:Param.numMacro + Param.numMicro, 1:Param.numUsers, 1:Param.maxCwdSize) = 0;
  CwdMatrixInfo(1:Param.numMacro + Param.numMicro, 1:Param.numUsers ) = struct('cwdSize',0);
