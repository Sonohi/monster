function [ x, y, valid ] = mobility ( scenario )
...
if (scenario == 1),
    ...
    figure
    hold on
    for (r = 1 : length(roads(1, :))),
        plot([roads(1, r) roads(1, r)], [roads(2, r) roads(4, r)], 'k');
        plot([roads(3, r) roads(3, r)], [roads(2, r) roads(4, r)], 'k');
        plot([roads(1, r) roads(3, r)], [roads(2, r) roads(2, r)], 'k');
        plot([roads(1, r) roads(3, r)], [roads(4, r) roads(4, r)], 'k');
    end
    plot(ones(1,311) * xf, -10:300, 'r');
    plot(-10 : 300, ones(1, 311) * yf, 'g');
    plot(x,y,'b');
    ...
    hold on
    plot(y)
    plot(ones(1,length(y))*xf,'k')
    plot(ones(1,length(y))*yf,'g')
