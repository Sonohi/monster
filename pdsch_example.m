...
% check the following example: <docid:lte_examples#example-PDSCHThroughputTM7to10Example PDSCH
% Throughput for Non-Codebook Based Precoding Schemes: Port 5 (TM7), 
% Port 7 or 8 or Port 7-8 (TM8), Port 7-14 (TM9 and TM10)>
%
